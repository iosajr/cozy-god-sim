...
Kinds are flags on that class, not subclasses. A divine exposure is a
memory with its divine flag set, sharing everything else.
...
- A place memory carries where it is, what is there, and when it was last
  seen. Animals, forest, water, farmland, other settlements.
- Re-observing a place updates when it was last seen, rather than freezing
  the first sighting as permanently true.
- Things stop being there because something physically happened — eaten,
  moved on — not because a decay chance was rolled.
- The player is never gated by any of this and always sees the whole
  world.
