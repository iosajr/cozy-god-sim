...
- Plain data: entities, settlements, buildings, tasks, events. No
  scene-tree types inside it.
- Stable ids. Anything referring to an entity holds its id.
...
A living continent: five or six cities' worth, around a thousand entities,
all of it moving whether or not anyone is watching.

Not everything needs the same depth to make that true. The entities the
