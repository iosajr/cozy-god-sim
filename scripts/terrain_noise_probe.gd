...
var _grass_base_instance: MultiMeshInstance3D
var _grass_variant_instance: MultiMeshInstance3D
...
func _rebuild_terrain_meshes() -> void:
	for instance in [_cliff_instance, _grass_base_instance, _grass_variant_instance, _trunk_instance, _canopy_instance]:
		if instance != null:
			instance.queue_free()
...
func _build_grass_multimeshes() -> void:
	...
	_grass_base_instance = _add_grass_multimesh_instance("GrassMultiMeshBase", mesh, base_xforms, _grass_base_material)
	_grass_variant_instance = _add_grass_multimesh_instance("GrassMultiMeshVariant", mesh, variant_xforms, _grass_variant_material)


func _add_grass_multimesh_instance(node_name: String, mesh: BoxMesh, xforms: Array[Transform3D], material: StandardMaterial3D) -> MultiMeshInstance3D:
	var multimesh: MultiMesh = MultiMesh.new()
	multimesh.transform_format = MultiMesh.TRANSFORM_3D
	multimesh.mesh = mesh
